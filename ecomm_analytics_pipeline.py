...
def load_sales_fact(**context):
    ...
    execution_date = context['ds']  # This gives you YYYY-MM-DD string
    ...
    insert_query = f"""
        ...
        WHERE DATE_TRUNC('month', o.order_purchase_timestamp::timestamp) = DATE_TRUNC('month', '{execution_date}'::date)
